...
var images_petrolina = [], x =0;
          images_petrolina[0] = 'http://200.238.105.69/imagens_radar/'+data0+min0+'0.cappi1km_PETR_trans.png';
          images_petrolina[1] = 'http://200.238.105.69/imagens_radar/'+data1+min1+'0.cappi1km_PETR_trans.png';
          images_petrolina[2] = 'http://200.238.105.69/imagens_radar/'+data2+min2+'0.cappi1km_PETR_trans.png';
		  images_petrolina[3] = 'http://200.238.105.69/imagens_radar/'+data3+min3+'0.cappi1km_PETR_trans.png';
		  images_petrolina[4] = 'http://200.238.105.69/imagens_radar/'+data4+min4+'0.cappi1km_PETR_trans.png';
		  images_petrolina[5] = 'http://200.238.105.69/imagens_radar/'+data5+min5+'0.cappi1km_PETR_trans.png';

var images_maceio = [], x =0;
          images_maceio[0] = 'http://200.238.105.69/imagens_radar/'+data0+min0+'0.cappi1km_MACEIO_trans.png';
          images_maceio[1] = 'http://200.238.105.69/imagens_radar/'+data1+min1+'0.cappi1km_MACEIO_trans.png';
          images_maceio[2] = 'http://200.238.105.69/imagens_radar/'+data2+min2+'0.cappi1km_MACEIO_trans.png';
		  images_maceio[3] = 'http://200.238.105.69/imagens_radar/'+data3+min3+'0.cappi1km_MACEIO_trans.png';
		  images_maceio[4] = 'http://200.238.105.69/imagens_radar/'+data4+min4+'0.cappi1km_MACEIO_trans.png';
		  images_maceio[5] = 'http://200.238.105.69/imagens_radar/'+data5+min5+'0.cappi1km_MACEIO_trans.png';

var images_natal = [], x =0;
          images_natal[0] = 'http://200.238.105.69/imagens_radar/'+data0+min0+'0.cappi1km_NATAL_trans.png';
          images_natal[1] = 'http://200.238.105.69/imagens_radar/'+data1+min1+'0.cappi1km_NATAL_trans.png';
          images_natal[2] = 'http://200.238.105.69/imagens_radar/'+data2+min2+'0.cappi1km_NATAL_trans.png';
		  images_natal[3] = 'http://200.238.105.69/imagens_radar/'+data3+min3+'0.cappi1km_NATAL_trans.png';
		  images_natal[4] = 'http://200.238.105.69/imagens_radar/'+data4+min4+'0.cappi1km_NATAL_trans.png';
		  images_natal[5] = 'http://200.238.105.69/imagens_radar/'+data5+min5+'0.cappi1km_NATAL_trans.png';



//console.log(images_natal);
